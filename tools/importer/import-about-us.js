...
const PAGE_TEMPLATE = {
  ...
  sections: [
    {
      id: 'rc1', name: 'intro', selector: ['#main-content > header.section.secondary-section'], style: 'grey', blocks: ['columns-intro'], defaultContent: [],
    },
    {
    ...
    {
      id: 'rc3', name: 'snapshot-gallery', selector: ['#main-content > section.section.secondary-section:nth-of-type(2)'], style: 'grey', blocks: ['cards-gallery'], defaultContent: ['#main-content > section.section.secondary-section:nth-of-type(2) .utility-text-align-center.utility-margin-bottom-8rem'],
    },
    {
    ...
    {
      id: 'rc5', name: 'latest-articles', selector: ['#main-content > section.section.secondary-section:nth-of-type(4)'], style: 'grey', blocks: ['cards-article'], defaultContent: ['#main-content > section.section.secondary-section:nth-of-type(4) .utility-text-align-center'],
    },
    {
      id: 'rc6', name: 'faq', selector: ['#main-content > section.section:nth-of-type(5)'], style: null, blocks: ['accordion-faq'], defaultContent: ['#main-content > section.section:nth-of-type(5) .h2-heading', '#main-content > section.section:nth-of-type(5) .subheading'],
    },
    {
...
// TRANSFORMER REGISTRY - cleanup first, then sections (afterTransform inserts breaks)
const transformers = [
  cleanupTransformer,
